...
public class KeyMapper {
     ...
     * value
     * @param splChar Adding special characters which needs shift operation
     */
    ...
    static {
        ...
        keyMap.put("mb-l", KeyEvent.BUTTON1_DOWN_MASK);
        keyMap.put("mb-m", KeyEvent.BUTTON2_DOWN_MASK);
        keyMap.put("mb-r", KeyEvent.BUTTON3_DOWN_MASK);
     ...
     */
    static boolean isSpecialChar(String key) {
